...
<video autoplay= "autoplay" loop="loop" id="video" height="384" width="683" controls="" preload="none" >
      <source id="webm" src="/images/posts/vim/multicursor" type="video/webm">
</video>
...
<video autoplay= "autoplay" loop="loop" id="video" height="384" width="683" controls="" preload="none" >
      <source id="webm" src="/images/posts/vim/calendar" type="video/webm">
</video>
...
这个不是插件实现的，很简单，手写几行代码就可以了，一键运行，一键编译，还可以配合gdb、pdb。。调试，非常方便。
